...
class _ServiceDetailOverviewScreenState
  ...
  void _openSparePartsSheet(BuildContext context) {
    showModalBottomSheet(
      ...
      builder: (ctx) => _SparePartsCatalogSheet(serviceTitle: widget.serviceTitle),
    );
  }
...
// ── Spare Parts Catalog Bottom Sheet ──────────────────────────────────────────

class _SparePartsCatalogSheet extends StatelessWidget {
  const _SparePartsCatalogSheet({required this.serviceTitle});
  ...
  Widget build(BuildContext context) {
    final parts = [
      {
        'title': 'Original Compressor Relay & Overload Protector',
        'price': '₹349',
        'tag': '100% Genuine',
        'warranty': '6 Months',
      },
      {
        'title': 'Universal Defrost Thermostat Sensor',
        'price': '₹289',
        'tag': 'OEM Quality',
        'warranty': '3 Months',
      },
      {
        'title': 'Magnetic Door Gasket Seal (Double Door)',
        'price': '₹499',
        'tag': 'A-Grade Rubber',
        'warranty': '6 Months',
      },
      {
        'title': 'Internal Cooling Fan Motor (12V DC)',
        'price': '₹649',
        'tag': 'Copper Winded',
        'warranty': '1 Year',
      },
            ...
            children: [
              const Column(
                ...
                children: [
                  ...
                  SizedBox(height: 2),
                  Text(
                    'Direct from verified manufacturers with doorstep delivery',
